...
LootJS.modifiers((event) => {
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("kubejs:hv_voucher").withChance(0.1),
    ...
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("naturescompass:naturescompass").withChance(0.15),
    ...
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("gtceu:lv_super_chest").withChance(0.3),
            Item.of("kubejs:lv_loot_bag").withChance(2),
            Item.of("gtceu:lv_miner").withChance(0.15),
            Item.of("gtceu:lv_pump").withChance(0.15),
            Item.of("gtceu:lv_solar_panel").withChance(0.1),
    ...
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("1x kubejs:mv_helper_computation_array").withChance((0.5 / 100) * 100),
            ...
            Item.of("gtceu:mv_super_tank").withChance(0.5),
            Item.of("kubejs:mv_loot_bag").withChance(2),
            Item.of("gtceu:mv_miner").withChance(0.15),
            Item.of("gtceu:mv_pump").withChance(0.15),
            Item.of("gtceu:mv_solar_panel").withChance(0.1),
            ...
            Item.of("8x gtceu:transistor").withChance(0.5),
    ...
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("1x kubejs:hv_helper_computation_array").withChance((0.5 / 100) * 100),
            Item.of("gtceu:hv_item_magnet").withChance((1 / 100) * 100),
            Item.of("4x gtceu:black_steel_ingot").withChance((3 / 100) * 100),
            Item.of({ type: "minecraft:item_nbt", item: "minecraft:enchanted_book", nbt: { StoredEnchantments: [{ id: "minecraft:fortune", lvl: 2 }] } }).withChance(0.25),
            Item.of({ type: "minecraft:item_nbt", item: "minecraft:enchanted_book", nbt: { StoredEnchantments: [{ id: "apotheosis:life_mending", lvl: 1 }] } }).withChance(0.25),
            Item.of({ type: "minecraft:item_nbt", item: "minecraft:enchanted_book", nbt: { StoredEnchantments: [{ id: "minecraft:looting", lvl: 1 }] } }).withChance(0.25),
            ...
            Item.of("gtceu:hv_super_chest").withChance(0.75),
            Item.of("gtceu:lv_super_tank").withChance(3),
            Item.of("kubejs:hv_loot_bag").withChance(2),
            Item.of("gtceu:hv_miner").withChance(0.15),
            Item.of("gtceu:hv_pump").withChance(0.25),
            Item.of("gtceu:hv_solar_panel").withChance(0.15),
            ...
            Item.of("2x minecraft:ender_eye").withChance(0.5),
            Item.of("1x kubejs:heart_of_gold").withChance(0.15)
        ])
    ...
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("gtceu:ev_super_chest").withChance(0.75),
            ...
            Item.of("bhc:red_heart").withChance(1),
            Item.of("2x minecraft:nether_star").withChance(0.5)
        ])
})
