ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu
        .steam_blast_furnace("kubejs:steam_blast_furnace_chts")
    ...
    event.recipes.gtceu.steam_blast_furnace("kubejs:steam_blast_furnace_cts").itemInputs("3x minecraft:iron_ingot", "1x minecraft:coal").itemOutputs("3x gtceu:steel_ingot").duration(700)

    event.recipes.gtceu.steam_blast_furnace("kubejs:steam_blast_furnace_coke").itemInputs("3x minecraft:iron_ingot", "1x gtceu:coke_gem").itemOutputs("3x gtceu:steel_ingot").duration(600)
    ...
    event.recipes.gtceu.steam_blast_furnace("kubejs:steam_blast_furnace_wriron").itemInputs("1x minecraft:iron_block").itemOutputs("1x gtceu:wrought_iron_block").duration(1800)
