ServerEvents.recipes(event => {
   ...
   event.shaped(
    ...
    event.recipes.gtceu.assembler("kubejs:heat_sheild")
    ...
    event.recipes.gtceu.assembler("kubejs:heat_accelerator")
    ...
    event.recipes.gtceu.assembler("kubejs:foundry_casing")
