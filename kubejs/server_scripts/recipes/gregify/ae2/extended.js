ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu
        ...
        .itemInputs("ae2:interface", "4x gtceu:iridium_plate", "gtceu:iv_electric_pump", "gtceu:iv_electric_piston", "2x #gtceu:circuits/iv")
    ...
    event.recipes.gtceu
        ...
        .itemInputs("ae2:drive", "gtceu:iridium_frame", "4x gtceu:osmium_plate", "2x #gtceu:circuits/iv")
