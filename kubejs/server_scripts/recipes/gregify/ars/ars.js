ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu
        .extractor("kubejs:archwood_to_mana_residue")
    ...
    event.recipes.gtceu
        .extractor("kubejs:magebloom_oil_berry")
    ...
    event.recipes.gtceu
        .chemical_bath("kubejs:magebloom_seed")
    ...
    event.recipes.gtceu.chemical_bath("kubejs:sourcestone").itemInputs("1x minecraft:stone").itemOutputs("1x ars_nouveau:sourcestone").inputFluids("kubejs:mana_residue 20").duration(20).EUt(120)
    ...
    event.recipes.gtceu
        .assembler("kubejs:imbuement_chamber_assembler")
        .itemInputs("4x gtceu:rose_gold_rod", "4x gtceu:rose_gold_screw", "1x gtceu:source_lens", "4x ars_nouveau:archwood_planks")
    ...
    event.recipes.gtceu
        .assembler("kubejs:arcane_core")
        .itemInputs("4x gtceu:rose_gold_gear", "1x gtceu:source_lens", "16x ars_nouveau:sourcestone", "1x gtceu:source_steel_frame")
        // .notConsumable('kubejs:lv_technician_helper')
    ...
    event.recipes.gtceu
        .assembler("kubejs:enchanting_apparatus")
        .itemInputs("2x gtceu:rose_gold_gear", "1x gtceu:exquisite_source_gem", "2x ars_nouveau:sourcestone", "2x gtceu:source_steel_plate")
        // .notConsumable('kubejs:lv_technician_helper')
    ...
    event.recipes.gtceu
        .assembler("kubejs:scribe_table")
        .itemInputs("2x gtceu:treated_wood_frame", "8x gtceu:stainless_steel_screw", "2x minecraft:ink_sac", "2x gtceu:source_steel_plate", "4x gtceu:long_stainless_steel_rod", "1x minecraft:feather")
        // .notConsumable('kubejs:lv_technician_helper')
    ...
    event.recipes.ars_nouveau.enchanting_apparatus(
        ["ars_nouveau:magebloom_fiber", "ars_nouveau:magebloom_fiber", "gtceu:source_lens", "gtceu:source_plate", "gtceu:rose_gold_rod", "gtceu:stainless_steel_bolt", "gtceu:stainless_steel_bolt"], // input items
