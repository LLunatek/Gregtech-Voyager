ServerEvents.recipes((event) => {
    ...
    assembly_no_research(
        "titanite_interplanetary_coordinatal_calculator",
        "kubejs",
        ...
        ["gtceu:soldering_alloy 1200", "gtceu:tungsten 800"],
        7680,
        100
    )
    assembly_no_research(
        "titanite_rocket_fin",
        "kubejs",
        ["8x kubejs:titanite_rocket_hull_plate", "32x gtceu:double_tungsten_steel_plate", "32x gtceu:hsse_plate", "2x #gtceu:circuits/luv"],
        ["gtceu:polybenzimidazole 4500"],
        7680,
        300
    )
    assembly_no_research(
        "titanite_rocket_nose_cone",
        "kubejs",
        ...
        ["gtceu:polybenzimidazole 8000", "gtceu:tungsten 4000"],
        7680,
        300
    )
    assembly_no_research(
        "ostrum_engine",
        "ad_astra",
        ["10x kubejs:titanite_rocket_hull_plate", "32x gtceu:martian-composite_frame", "48x gtceu:hsse_plate", "8x gtceu:tungsten_steel_fluid_cell", "gtceu:extreme_combustion_engine"],
        ["gtceu:polybenzimidazole 8000", "gtceu:tungsten 4000"],
        7680,
        180
    )
    assembly_no_research(
        "ostrum_tank",
        "ad_astra",
        ["6x kubejs:titanite_rocket_hull_plate", "32x gtceu:tungsten_steel_fluid_cell", "64x gtceu:hsse_plate", "2x #gtceu:circuits/luv"],
        ["gtceu:polybenzimidazole 8000", "gtceu:tungsten 4000"],
        7680,
        300
    )
