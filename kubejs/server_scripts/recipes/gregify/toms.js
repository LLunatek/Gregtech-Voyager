ServerEvents.recipes((event) => {
    event.recipes.gtceu
        ...
        .itemInputs("gtceu:aluminium_frame", "gtceu:aluminium_crate", "6x gtceu:treated_wood_plate", "2x gtceu:energetic_alloy_gear")
    ...
    event.recipes.gtceu
        ...
        .itemInputs("gtceu:sterling_silver_normal_item_pipe", "2x gtceu:treated_wood_frame", "1x gtceu:pearlic_steel_gear")
    ...
    event.recipes.gtceu
        ...
        .itemInputs("gtceu:sterling_silver_small_item_pipe", "2x gtceu:treated_wood_frame", "1x gtceu:small_pearlic_steel_gear")
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            "1x gtceu:energetic_alloy_frame",
            "1x gtceu:stainless_steel_gear",
            "toms_storage:ts.storage_terminal",
            "2x gtceu:double_silicon_plate",
