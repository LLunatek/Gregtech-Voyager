...
function beam_heating(output, ns, inputItems, nonconsumed, inputFluid, outFluid, eut, time, concentration)  
{
    ...
    beam_heating('trellium_ingot', 'gtceu', 'gtceu:trellium_base_ingot', 'kubejs:atomic_lattice', 'gtceu:naquadah ' + 144*4, 'gtceu:impure_naquadria_solution 1500', 32000, 100, .35)
