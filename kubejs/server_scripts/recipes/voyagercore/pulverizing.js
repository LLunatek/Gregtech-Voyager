ServerEvents.recipes((event) => {
    ...
    function pulverizing(rock, tier, output, inF, time, eut, outF) {
        ...
        event.recipes.gtceu
            .pulverizing("kubejs:rock_" + rock + "_to_ores")
        ...
        event.recipes.gtceu
            .pulverizing("kubejs:med_rock_" + rock + "_to_ores")
        ...
        event.recipes.gtceu
            .pulverizing("kubejs:large_rock_" + rock + "_to_ores")
    ...
    assembly_research(
        ...
        "voyagercore",
        [
            "1x gtceu:large_maceration_tower",
            "64x gtceu:fine_perfected_electrum_wire",
            "8x gtceu:calorite_gear",
            "8x #gtceu:circuits/zpm",
            "4x gtceu:hsse_buzz_saw_blade",
            "8x gtceu:luv_conveyor_module",
            "8x gtceu:luv_electric_piston",
            "16x gtceu:luv_electric_motor"
        ],
        ["voyagercore:high_stress_lubricant 8000", "gtceu:tungsten 16000"],
        32000,
        60,
    ...
    const moon_ores = [
        ...
        "2x gtceu:crushed_neodymium_ore",
        "2x gtceu:crushed_bornite_ore",
        "2x gtceu:crushed_lunite_ore",
        "2x gtceu:crushed_chromite_ore",
        "2x gtceu:crushed_ilmenite_ore"
    ]

    const mars_ores = [
        "2x gtceu:crushed_cobaltite_ore",
        "2x gtceu:crushed_uraninite_ore",
        "2x gtceu:crushed_cooperite_ore",
        "2x gtceu:crushed_dalumite_ore",
        "2x gtceu:crushed_scheelite_ore",
        "2x gtceu:crushed_plutonium_ore"
    ]

    const venus_ores = [
        "6x gtceu:crushed_electrotine_ore",
        "6x gtceu:crushed_redstone_ore",
        "4x gtceu:crushed_chlorite_ore",
        "4x gtceu:crushed_fluorite_ore",
        "2x gtceu:crushed_xastinite_ore",
        "64x gtceu:venus_sand_dust"
    ]
