ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu
        .circuit_assembler("kubejs:ev_t1")
        .itemInputs(
            ...
            "32x gtceu:fluxed_cobalt_electrum_bolt"
        )
     ...
     */
    function circuit_assembler_recipe(
        name,
        output,
        component_count,
        circuit_board,
    ...
    circuit_assembler_recipe(
        "quantum_processor",
        "2x gtceu:quantum_processor",
        "low",
        "gtceu:fiber_reinforced_printed_circuit_board",
        ["gtceu:nano_cpu_chip", "gtceu:smd_capacitor", "gtceu:smd_transistor"],
        "gtceu:qbit_cpu_chip",
        "low",
        "refined_fluxed_electrum",
        false,
    ...
    circuit_assembler_recipe(
        ...
        "mid",
        "gtceu:fiber_reinforced_printed_circuit_board",
        ["gtceu:quantum_processor", "gtceu:smd_capacitor", "gtceu:smd_inductor"],
        "gtceu:ram_chip",
        "mid",
        "refined_fluxed_electrum",
        false,
    ...
    circuit_assembler_recipe(
        ...
        "mid",
        "gtceu:fiber_reinforced_printed_circuit_board",
        ["gtceu:quantum_processor_assembly", "gtceu:smd_diode", "gtceu:ram_chip"],
        "gtceu:nor_memory_chip",
        "mid",
        "titanite",
        false,
    ...
    circuit_assembler_recipe(
        ...
        "high",
        "gtceu:fiber_reinforced_printed_circuit_board",
        ["gtceu:quantum_processor_computer", "gtceu:advanced_smd_capacitor", "gtceu:advanced_smd_inductor"],
        "gtceu:qbit_cpu_chip",
        "high",
        "titanite",
        true,
