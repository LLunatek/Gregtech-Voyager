...
ServerEvents.recipes(event => {
    ...
    smd("transistor", 32, 
        ['2x gtceu:gallium_foil',
            '1x gtceu:kyanite_dust',
            '8x gtceu:fine_tantalum_wire']
    )
    smd("resistor", 32, ['1x gtceu:carbon_dust',
            '2x gtceu:kyanite_dust',
            '6x gtceu:fine_tantalum_wire']
    )
    smd("capacitor", 24, ['4x gtceu:tantalum_foil',
            '2x gtceu:silicone_rubber_foil',
            '1x gtceu:kyanite_dust'])
    smd("inductor", 24, ['2x gtceu:nickel_zinc_ferrite_ring',
            '2x gtceu:fine_tantalum_wire',
            '1x gtceu:kyanite_dust'])
    smd("diode", 48, ['1x gtceu:gallium_arsenide_dust',
