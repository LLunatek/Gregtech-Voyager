ServerEvents.recipes(event => {
    ...
    {
        event.recipes.gtceu.laser_engraver(`gtceu:${output}`)
        .itemInputs(inputs)
        .itemOutputs(`${namespace}:${output}`)
        .duration(time * 20)
        .EUt(eut)
    ...
    venus_assembly_research('nether_star_beam', 'voyagercore', ['4x kubejs:light_refractor', '2x gtceu:titanite_alloy_frame', '64x gtceu:double_calorite_plate', '8x gtceu:quantum_star', '2x gtceu:nether_star_lens', '16x #gtceu:circuits/luv', '64x gtceu:fine_titanite_alloy_wire'],
    ...
    venus_assembly_research('beam_of_teus', 'voyagercore', ['4x gtceu:luv_laser_engraver', '4x #gtceu:circuits/zpm', '4x #gtceu:circuits/luv', '16x gtceu:iv_field_generator', '8x gtceu:lunarium_block', '64x gtceu:fine_titanite_alloy_wire'],
        ['gtceu:titanite 16000' ,'gtceu:vanadium_gallium 4000', 'gtceu:polybenzimidazole 4000'], 8000 * 4, 120, 'voyagercore:nether_star_beam'
    )
