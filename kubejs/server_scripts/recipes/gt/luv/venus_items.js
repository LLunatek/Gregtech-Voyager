ServerEvents.recipes(event => {
    ...
    venus_assembly_research('nether_star_beam', 'voyagercore', ['4x kubejs:light_refractor', '2x gtceu:titanite_alloy_frame', '12x gtceu:double_calorite_plate', '8x gtceu:quantum_star', '2x gtceu:nether_star_lens', '16x #gtceu:circuits/luv', '64x gtceu:fine_titanite_alloy_wire'],
