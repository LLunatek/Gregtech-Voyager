ServerEvents.recipes((event) => {
    ...
    assembly_research(
        ...
        [
            ...
            "gtceu:perfected_electrum_frame",
            "64x gtceu:crystal_soc",
            "12x gtceu:double_duranium_plate",
            "8x kubejs:light_refractor",
            "8x gtceu:luv_field_generator",
            "8x #gtceu:circuits/zpm",
            "64x gtceu:fine_europium_wire"
        ],
        ["gtceu:lunarium 32000", "gtceu:naquadah 8000", "voyagercore:high_stress_lubricant 16000"],
        32000,
        60,
