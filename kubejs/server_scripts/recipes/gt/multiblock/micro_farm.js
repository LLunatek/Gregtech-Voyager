ServerEvents.recipes((event) => {
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:microfarm_grass_1")
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:microfarm_grass_2")
    //     .notConsumable("minecraft:grass")
    //     .circuit(2)
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:microfarm_grass_3")
    //     .notConsumable("minecraft:grass")
    //     .circuit(3)
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:magebloom_farm")
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:magebloom_farm_helper")
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:cocoa_helper")
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:wheat_helper")
    ...
    // event.recipes.gtceu
    //     .micro_farm("kubejs:sugar_cane_helper")
