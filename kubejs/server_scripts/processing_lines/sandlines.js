...
function atm_collect(circuit, ns, itemOutput, cntI, fluidOutput, cntF, time, eut, dimension)
{
    ...
    centrifuge('venus_sand', '15x gtceu:venus_sand_dust', [], ['3x gtceu:basalt_dust', '2x gtceu:titanium_dust', 'gtceu:calorite_dust', '6x gtceu:inert_sulfur_dust'], 'gtceu:sulfuric_acid 250', 60, 1024)
