ServerEvents.recipes((event) => {
    ...
    create_recipe_lcr("dewatering_fluid", ["2x gtceu:barium_dust", "gtceu:zinc_dust"], "gtceu:kerosene 2000", [], "kubejs:dewatering_fluid 5000", 40, 480)

    create_recipe_lcr("dewatering_fluid", ["2x gtceu:barium_dust", "gtceu:zinc_dust"], "gtceu:kerosene 1200", [], "kubejs:dewatering_fluid 6000", 30, 400, "basic_chemist_helper")
    ...
    create_recipe_lcr("impure_rhodium_sludge", ["gtceu:calcium_hydroxide_dust"], ["gtceu:sulfuric_rhodium_solution 1000"], ["3x gtceu:impure_rhodium_sludge_dust"], [], 5, 120)
